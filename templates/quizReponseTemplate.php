...
<div class="container" id="quiz">
    <div class="row">
        <div class="col-md-8 col-md-offset-2 panel" id="panel1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title text-danger">
                        <i class="fa fa-question-circle fa-3x"></i> 1. The First Question？   
                    </h3>
                </div>
                ...
                <div class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button id="step2" type="button" class="btn btn-primary btn-sm btn-block">
                               next</button>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="panel col-md-8 col-md-offset-2" id="panel2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title text-danger">
                        <i class="fa fa-question-circle fa-3x"></i> 2. The Second Question？  
                    </h3>
                </div>
                <div class="panel-body two-col">
                    <div class="row">
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <button id="step1" type="button" class="btn btn-success btn-sm btn-block">
                                <span class="fa fa-send"></span>back</button>
                        </div>
                        <div class="col-md-6">
