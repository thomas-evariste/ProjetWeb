		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card_insc">
				...
				<div class="d-flex justify-content-center form_container">
					<form  action="index.php?action=validateModificationQuestionnaire&controller=prof" method="post">
						<table>
<!--
						<tr class="input-group mb-3">
							<td><input type="text" name="login" class="form-control input_user" value="" placeholder="Login :"></td>
						</tr>
-->								<td><input type="hidden" name="idQuestionnaire" class="form-control input_user" value="<?php echo $questionnaire->getId() ?>" placeholder="Titre* :"></td>
<tr class="input-group mb-3">
