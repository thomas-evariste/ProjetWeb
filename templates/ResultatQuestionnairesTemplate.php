        ...
        <?php 
            ...
            foreach($questionnaires as $questionnaire){
				...
				<form action=\"index.php?action=classementQuiz&controller=user\" method=\"POST\"><input type='hidden' name='questionnaireId' value='".$questionnaire['id']."'><input type='submit' value='Classement'></form>
				";
