                        ...
                        <div class="col-md-4">
    						...
    						<input type="<?php echo $type ?>" id="<?php echo $type ?>-button-<?php echo $numero+1 ?>-<?php echo $numero_reponse+1 ?>" name="<?php echo $type ?>-button-<?php echo $numero ?>" value="<?php echo $reponse['id_proposition'] ?>">
