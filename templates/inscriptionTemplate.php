				...
				<div class="d-flex justify-content-center form_container">
					...
					<h2 class="titre-insc">Inscription</h2>
						...
						<tr class="input-group mb-2">
							<td><input type="text" name="majeure" class="form-control input_user" value="" placeholder="Majeure :"></td>
						</tr>
						<tr class="input-group mb-2">
							<td><input type="text" name="promotion" class="form-control input_user" value="" placeholder="Promotion :"></td>
						</tr>
						<tr class="input-group mb-3">
