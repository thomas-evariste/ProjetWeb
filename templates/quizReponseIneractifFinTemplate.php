    ...
    <div class="row">
        <div class="panel col-md-8 col-md-offset-2" id="panel<?php echo $numero+1 ?>">
            <div class="panel panel-default">
                ...
                <div class="panel-body two-col">
                    <div class="row">
                        <div class="col-md-4">
    						...
    						<input type="radio" id="radio-button-<?php echo $numero+1 ?>-1" name="radio-button<?php echo $numero+1 ?>." value="5">
                        ...
                        <div class="col-md-4">
    						...
    						<input type="radio" id="radio-button-<?php echo $numero+1 ?>-2" name="radio-button<?php echo $numero+1 ?>." value="5">
                        ...
                        <div class="col-md-4">
                            <div class="frb frb-danger margin-bottom-none">
    						<input type="radio" id="radio-button-<?php echo $numero+1 ?>-3" name="radio-button<?php echo $numero+1 ?>." value="5">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="frb frb-danger margin-bottom-none">
    						<input type="radio" id="radio-button-<?php echo $numero+1 ?>-4" name="radio-button<?php echo $numero+1 ?>." value="5">
                        ...
                        <div class="col-md-4">
                            <div class="frb frb-danger margin-bottom-none">
    						<input type="radio" id="radio-button-<?php echo $numero+1 ?>-5" name="radio-button<?php echo $numero+1 ?>." value="5">
                        ...
                        <div class="col-md-4">
                            <div class="frb frb-danger margin-bottom-none">
    						<input type="radio" id="radio-button-<?php echo $numero+1 ?>-6" name="radio-button<?php echo $numero+1 ?>." value="5">
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <button id="step<?php echo $numero ?>" type="button" class="btn btn-success btn-sm btn-block">
